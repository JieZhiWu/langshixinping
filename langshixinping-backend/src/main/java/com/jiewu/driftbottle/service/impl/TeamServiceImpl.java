...
import com.jiewu.driftbottle.model.enums.TeamStatusEnum;
...
import com.jiewu.driftbottle.model.vo.UserVO;
import com.jiewu.driftbottle.service.TeamService;
import com.jiewu.driftbottle.mapper.TeamMapper;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        //  重复加入队伍的问题（加锁，分布式锁）
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("langshi:joinTeam:");
        ...
        try {
            while (true) {
                if (lock.tryLock(0, -1, TimeUnit.MILLISECONDS)) {
                    ...
                    if (hasJoinNum > 20) {
                        throw new BusinessException(ErrorCode.PARAMS_ERROR, "最多创建和加入20个队伍");
                    }
                    //不能重复加入已加入的队伍
